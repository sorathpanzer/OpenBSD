...
const char *spcmd1[] = {"kitty", "--class", "spterm", "--override=initial_window_width=80c", "--override=initial_window_height=34c", NULL };
//const char *spcmd2[] = {"st", "-n", "spfm", "-g", "144x41", "-e", "ranger", NULL };
//const char *spcmd3[] = {"keepassxc", NULL };
static Sp scratchpads[] = {
	/* name          cmd  */
	{"spterm",      spcmd1},
//home	{"spranger",    spcmd2},
//	{"keepassxc",   spcmd3},
};
...
static const char *termcmd[]  = { "kitty", "-e", "nu", NULL };
